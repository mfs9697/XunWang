...
% Hyperlinks and highlighted references
% ------------------------------------------------------------
\usepackage[dvipsnames]{xcolor}

\usepackage[
colorlinks=true,
linkcolor=RoyalBlue,   % equations, figures, tables, sections
citecolor=BrickRed,    % citations
urlcolor=ForestGreen,  % URLs
filecolor=RoyalBlue
]{hyperref}

\usepackage[nameinlink,noabbrev]{cleveref}

% Names used by cleveref
...
\begin{document}
	...
	\begin{itemize}
		\item Plant-stem-inspired composite cylindrical truss lattice structures are proposed.
		\item Theoretical models for compressive modulus and strength are established and validated by experiments and finite element simulations.
		\item The stiffness, strength, and impact energy absorption characteristics of low-density cylindrical truss lattice structures are revealed.
	\end{itemize}
	
	\begin{abstract}
		Lightweight lattice structures have attracted considerable research attention because of their high geometric symmetry, low density, and superior mechanical efficiency. Inspired by the excellent stiffness characteristics of plant stems, four composite cylindrical truss lattice structures with distinct topological configurations are designed to meet the requirements for load-bearing capacity and impact resistance in curved aerospace components. Theoretical prediction models for the compressive modulus and compressive strength are established based on the energy method. The load-bearing and energy absorption characteristics of the cylindrical truss lattice structures under quasi-static compression and impact loading are analyzed using finite element simulations. Composite cylindrical truss lattice structures are fabricated by selective laser sintering, and quasi-static compression and low-velocity impact experiments are conducted to verify the accuracy of the theoretical models and numerical simulations. The results demonstrate that relative density and topological configuration have significant effects on the stiffness, strength, and impact energy absorption properties of cylindrical truss lattice structures. This work clarifies the load-bearing and energy absorption mechanisms of low-density cylindrical truss lattice structures and provides a theoretical basis for the lightweight design and mechanical-performance optimization of curved aerospace structures.
	\end{abstract}
	
	\noindent\textbf{Keywords:} Lattice structures; Compressive modulus; Compressive strength; Impact energy absorption; Cylindrical truss lattice structures
...
Within the considered geometric range, increasing the outer radius generally increases the relative density, indicating that a larger outer radius corresponds to a denser material distribution in the cylindrical structure. The relative-density variation also depends strongly on the topological configuration. For example, the tesseract cylindrical lattice structure has the lowest relative density among the four configurations considered. This result shows that, in addition to geometric dimensions, structural topology plays an important role in determining the relative density. Owing to their distinct strut arrangements and connectivity characteristics, the four structures exhibit different relative-density evolution trends under the same geometric parameter variations. Therefore, relative density can be effectively regulated by adjusting the geometric parameters, providing a basis for subsequent optimization of the mechanical properties of composite cylindrical truss lattice structures.
	...
	\begin{figure}[htbp]
		\centering
		\includegraphics[width=.9\textwidth]{image8}
		...
		\includegraphics[width=.9\textwidth]{image11}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.75\textwidth]{image21}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.60\textwidth]{image22}
...
The collected force--displacement data were processed to obtain the compressive stress--strain curves of the composite cylindrical truss lattice structures, as shown in Figure~\ref{fig13}. The mechanical response curves exhibit three distinct stages: linear elasticity, plastic yielding, and buckling failure. The mechanical properties of the structures decrease as the unit-cell size increases. When the strut diameter remains constant, increasing the unit-cell size reduces the relative density of the lattice structure, thereby lowering its compressive stiffness and strength. In addition, a larger unit cell results in a higher slenderness ratio of the struts and a lower peak stress. This indicates that lattice structures with lower relative density are more prone to buckling failure.

The compressive modulus and compressive strength of the cylindrical truss lattice structures increase significantly with increasing relative density, demonstrating that relative density is a key geometric parameter governing load-bearing capacity. Further analysis shows that lattice structures with different topological configurations exhibit distinct mechanical properties at the same relative density. Specifically, the face-centered cubic cylindrical lattice structure retains high stiffness and strength even at low relative densities, whereas the tesseract cylindrical lattice structure undergoes buckling and instability at an earlier stage. These findings provide useful guidance for the design of lightweight load-bearing components based on composite cylindrical truss lattice structures.
...
The compressive mechanical response curves obtained from finite element simulations are presented in Figure~\ref{fig13}(a)--(d). The simulated compressive modulus and strength agree well with the experimental results. Lattice structures of the same type but with different dimensions exhibit similar mechanical responses, including a typical linear elastic stage, a peak stress associated with buckling deformation, and subsequent structural failure accompanied by a decrease in load. This trend is consistent with the mechanical characteristics of lattice structures reported in previous studies.

As the unit-cell size decreases, the relative density increases, resulting in higher load levels in the stress--strain curves. Since lattice structures of the same type exhibit similar deformation and failure modes under compression, only the deformation processes of cylindrical truss lattice structures with a unit-cell height of \SI{15}{mm} are shown in Figure~\ref{fig14}(a)--(d). The compressive buckling deformation of the struts observed in the numerical simulations agrees well with the experimental observations. However, because no fracture criterion was defined for the base material in the finite element model, fracture of nodes or struts does not occur in the simulation results.

For the body-centered cubic cylindrical lattice structure, buckling first occurs in the vertical struts, whereas no obvious deformation is observed in the inclined struts. As the compressive strain increases, the vertical struts continue to buckle and the connecting nodes deform, followed by deformation of the inclined struts. Correspondingly, the compressive stress rapidly reaches its peak value. Further loading causes fracture of both vertical and inclined struts, leading to a sharp drop in stress on the stress--strain curve. Figure~\ref{fig14}(a) shows the deformation contour associated with strut buckling at a strain of $\varepsilon=0.02$, clearly illustrating the buckling of the vertical struts. With continued compression, the vertical struts undergo progressive buckling and mid-strut fracture until the entire body-centered cubic cylindrical lattice structure collapses.
...
Figure~\ref{fig16} compares the numerical and experimental results for the composite cylindrical truss lattice structures under low-velocity impact loading. The mechanical responses of the four cylindrical lattice configurations during impact are shown in this figure. As listed in Table~\ref{tab4}, the maximum average error in peak load between the finite element simulations and experimental tests is less than 5.61\%. The local offset in the load--displacement curves is mainly attributed to slight differences in the initial contact conditions during testing, such as minor initial gaps between the specimens and the impact head, as well as the simplified treatment of strain-rate sensitivity in the material constitutive model~\cite{Ref51,Ref52}. Overall, the established finite element model for low-velocity impact can effectively simulate the dynamic mechanical response of the cylindrical truss lattice structures.

Benefiting from uniform strut distribution and dense connecting nodes, the face-centered cubic cylindrical lattice structure exhibits superior stiffness and stability under impact, as reflected by the gently decreasing load curve. In contrast, the body-centered cubic and tesseract cylindrical lattice structures contain fewer struts, leading to earlier buckling and instability under the same impact energy, accompanied by a rapid drop in load. Owing to its high density of strut connections, the octahedral cylindrical lattice structure achieves coordinated load transfer through multidirectional inclined struts during impact, thereby delaying overall structural failure.
...
To evaluate the energy absorption performance of the composite cylindrical lattice structures under impact loading, the conventional energy absorption index $E_a$ was normalized by mass. Therefore, the specific energy absorption $W_{\mathrm{SEA}}$ is defined as the total absorbed energy divided by the structural mass:
%
\begin{equation}
...
A normalization analysis was conducted to compare the mechanical properties of the proposed cylindrical truss lattice structures with those of other common lattice structures while eliminating the influence of base-material parameters. The results are shown in Figure~\ref{fig18}. Among the four configurations investigated in this study, the face-centered cubic cylindrical lattice structure exhibits the best overall mechanical performance, whereas the body-centered cubic cylindrical lattice structure shows relatively lower normalized properties.

The four proposed cylindrical lattice structures were further compared with lattice structures reported in the literature. The present structures exhibit higher relative compressive modulus than conventional lattice configurations. In terms of relative compressive strength, the tesseract cylindrical lattice structure shows prominent load-bearing advantages at low relative densities. By contrast, the body-centered cubic and octahedral cylindrical lattice structures exhibit load-bearing capacities comparable to those of other lattice structures. These comparisons demonstrate that the proposed composite cylindrical truss lattice structures offer competitive mechanical performance and are promising candidates for lightweight load-bearing applications.
...
\begin{figure}[htbp]
	...
	\includegraphics[width=0.80\textwidth]{image43}
...
This study extends the design of traditional cubic truss lattice structures to composite cylindrical truss lattice structures and establishes theoretical models for their low-density configurations. The accuracy of the theoretical models is verified through numerical simulations and experimental tests. The mechanical properties, deformation characteristics, and energy absorption performance of the proposed cylindrical truss lattice structures are systematically investigated under quasi-static compression and impact loading. The main conclusions are summarized as follows:
...
\begin{enumerate}[label=(\arabic*)]
	...
	\item As illustrated in the Ashby material-selection chart, where the horizontal axis represents relative density and the vertical axes represent relative compressive modulus and relative compressive strength, the proposed structures outperform many conventional lattice structures. These results indicate that composite cylindrical truss lattice structures, especially the face-centered cubic and tesseract configurations, have strong potential for lightweight load-bearing and impact-resistant applications.
\end{enumerate}
