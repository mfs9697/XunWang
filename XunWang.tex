...
\end{table}
	...
	\begin{equation}
		\begin{aligned}
			U_b^p &= \frac{\big(F_b^p\big)^2\kappa_{1,1}}{2A_{10}E_s}, \\
	...
	\begin{equation}
		\begin{aligned}
			U_b^v &= \frac{\big(F_b^v\big)^2\kappa_{1,1}^3}{6E_sI_1}, \\
	...
	\begin{multline}
			...
			{16\big(R_1^2-r_1^2\big)\kappa_{1,1}^5}
			+\frac{9d_1^4l_{1,2}^2l_1}
			{16\big(R_1^2-r_1^2\big)\kappa_{1,2}^5} \\
			+\frac{27d_1^6l_1^3}
			{1024\big(R_1^2-r_1^2\big)\kappa_{1,1}^7}
			+\frac{27d_1^6l_1^3}
			{1024\big(R_1^2-r_1^2\big)\kappa_{1,2}^7}
			\Bigg]E_s .
		\label{Eq18}
	\end{multline}
	...
	\begin{multline}
			...
			+\frac{9d_2^4\big(R_2-r_2\big)^2l_2}
			{2l_{2,4}^5\big(R_2^2-r_2^2\big)}
			+\frac{27d_2^6l_2^3}
			{8l_{2,4}^7\big(R_2^2-r_2^2\big)} \\
			+\frac{18d_2^4\kappa_{2,1}^2l_2}
			{l_{2,1}^5\big(R_2^2-r_2^2\big)}
			+\frac{18d_2^4\kappa_{2,2}^2l_2}
			{l_{2,2}^5\big(R_2^2-r_2^2\big)} 
			+\frac{6d_2^2l_2^3}
			{l_{2,1}^3\big(R_2^2-r_2^2\big)}
			+\frac{8d_2^2l_2^3}
			{l_{2,2}^3\big(R_2^2-r_2^2\big)}
			\Bigg]E_s .
		\label{Eq19}
	\end{multline}
	%
	...
	\begin{equation}
		\begin{aligned}
			...
			\\
			&\qquad+\frac{9d_3^4\kappa_{4,2}^2l_3}
			...
			\\
			&\qquad+\frac{9d_3^4\kappa_{6,2}^2l_3}
	...
	\begin{aligned}
		...
		\kappa_{6,1}
		&=
		\frac{\big(\sqrt{6}+\sqrt{2}\big)\left(R_3-r_3\right)}
		{4\big(R_3+r_3\big)}r_3, \\
		\kappa_{6,2}
		&=
		\frac{\big(\sqrt{6}+\sqrt{2}\big)\left(R_3-r_3\right)}
